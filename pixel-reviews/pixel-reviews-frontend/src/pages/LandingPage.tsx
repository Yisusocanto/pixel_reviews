...
const LandingPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen text-foreground overflow-x-hidden">
      {/* Hero Section */}
      <section className="relative flex flex-col items-center justify-center px-4 pt-32 pb-20 text-center md:pt-40 md:pb-32 lg:pt-48 lg:pb-40">
        {/* Decorative Elements */}
        ...
        >
          ...
          >
            Discover & Share <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 animate-text-gradient bg-300%">
              Your Gaming Journey
            </span>
          </motion.h1>
          ...
          >
            <Link to="/auth/signup">
              <AccentButton
                size="xl"
                className="px-8 py-4 text-lg shadow-lg shadow-blue-500/20 transition-transform hover:scale-105"
              >
            ...
            <Link to="/feed">
              <Button
                variant="outline"
                size="lg"
                className="h-auto px-8 py-4 text-lg rounded-2xl border-white/10 bg-white/5 hover:bg-white/10 backdrop-blur-sm transition-all hover:border-white/20"
              >
                Explore Reviews
              </Button>
            </Link>
        ...
        <div className="max-w-4xl mx-auto text-center p-10 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md">
          ...
          >
            ...
            <Link to="/auth/signup">
              <AccentButton
                size="xl"
                className="px-10 py-5 text-xl shadow-xl shadow-blue-500/10 hover:shadow-blue-500/20 mx-auto"
              >
                Create Free Account
              </AccentButton>
            </Link>
